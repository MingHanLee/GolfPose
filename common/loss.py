...
def bonelen_consistency_loss(dataset,keypoints,pred_out):
    ...
    if dataset == 'h36m':
        ...
        bones = [(0,1), (0,4), (1,2), (2,3), (4,5), (5,6), (0,7), (7,8), (8,9), (9,10), 
                    (8,11), (11,12), (12,13), (8,14), (14,15), (15,16), (17, 18), (18, 19), (19, 20), (19, 21)]

        if pred_out.shape[2] == 17 or pred_out.shape[2] == 18:
            bones = bones[:-4]
        elif pred_out.shape[2] == 19:
            bones = bones[:-3]
        elif pred_out.shape[2] == 20:
            bones = bones[:-2]
        elif pred_out.shape[2] == 21:
            bones = bones[:-1]
...
def clublen_consistency_loss(dataset, keypoints, pred_out):
    loss_length = 0

    if pred_out.shape[1] <= 17:
        return loss_length

    bones = [(17, 18), (18, 19), (19, 21), (19, 20)]
