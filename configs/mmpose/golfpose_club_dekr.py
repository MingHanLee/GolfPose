...
# dataset_type = "GolfswingClubDataset"
...
val_evaluator = dict(type="CocoMetric", ann_file=f"{data_root}coco/hscc_golf_club_2d_test.json", nms_mode="none", score_mode="keypoint")
test_evaluator = dict(type="CocoMetric", ann_file=f"{data_root}coco/hscc_golf_club_2d_test.json", nms_mode="none", score_mode="keypoint")
